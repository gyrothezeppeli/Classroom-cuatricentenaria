...
// Fijo para 1er grado, Sección C
const GRADO_ACTUAL = '1er grado';
const SECCION_ACTUAL = 'C';
    ...
    <div style={{ 
      ...
      <main style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem 5rem' }}>
        ...
        {seccionActiva === 'tareas' && (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            <div style={formCardStyle}>
              <h3 style={labelStyle}>➕ Nueva Asignación - 1ro C</h3>
              <div style={gridStyle}>
                <input 
                  type="text" 
            ...
            {tareas.length === 0 && (
              <div style={emptyStateStyle}>
                ...
                <p>No hay tareas asignadas para 1ro C</p>
        ...
        {seccionActiva === 'avisos' && (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            <div style={formCardStyle}>
              <h3 style={labelStyle}>📢 Publicar Aviso para 1ro C</h3>
              <div style={gridStyle}>
                <input 
                  type="text" 
            ...
            {avisos.length === 0 && (
              <div style={emptyStateStyle}>
                <span style={{ fontSize: '3rem' }}>📢</span>
                <p>No hay avisos publicados para 1ro C</p>
        ...
        {seccionActiva === 'materiales' && (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            <div style={formCardStyle}>
              <h3 style={labelStyle}>📚 Agregar Material de Estudio - 1ro C</h3>
              <div style={gridStyle}>
                <input 
                  type="text" 
            ...
            {materiales.length === 0 && (
              <div style={emptyStateStyle}>
                <span style={{ fontSize: '3rem' }}>📚</span>
                <p>No hay materiales disponibles para 1ro C</p>
        ...
        {seccionActiva === 'guias' && (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            <div style={formCardStyle}>
              <h3 style={labelStyle}>📘 Agregar Guía de Estudio - 1ro C</h3>
              <div style={gridStyle}>
                <input 
                  type="text" 
            ...
            {guias.length === 0 && (
              <div style={emptyStateStyle}>
                <span style={{ fontSize: '3rem' }}>📘</span>
                <p>No hay guías de estudio disponibles para 1ro C</p>
        ...
        {seccionActiva === 'plan' && (
          <div style={{ animation: 'fadeIn 0.5s ease' }}>
            <div style={formCardStyle}>
              <h3 style={labelStyle}>📊 Plan de Evaluación - 1er Grado C</h3>
              <div style={gridStyle}>
                <input 
                  type="text" 
                  placeholder="MATERIA" 
            ...
            {planEvaluacion.length === 0 ? (
              <div style={emptyStateStyle}>
                <span style={{ fontSize: '3rem' }}>📊</span>
                <p>No hay evaluaciones registradas para 1ro C</p>
      ...
      <footer style={{ textAlign: 'center', padding: '4rem', opacity: 0.3, fontSize: '0.8rem', letterSpacing: '2px' }}>
        <p>© 2026 U.E CIUDAD CUATRICENTENARIA • 1er Grado - Sección C</p>
